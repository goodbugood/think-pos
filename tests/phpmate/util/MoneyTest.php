...
class MoneyTest extends TestCase
{
    ...
    {
        $money = Money::valueYuan('1.23')->add(Money::valueYuan('0.01'));
    ...
    {
        $money = Money::valueYuan('1.23')->sub(Money::valueYuan('0.01'));
    ...
    {
        $money = Money::valueYuan('1.23')->mul('2');
    ...
    {
        $money = Money::valueYuan('1.23')->div('2');
