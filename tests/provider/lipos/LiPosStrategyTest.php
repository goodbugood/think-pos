...
class LiPosStrategyTest extends TestCase
{
    ...
    function handleCallbackOfPosTrans()
    {
        ...
        // 押金交易回调
        $content = '{"serviceType":"PAY_ORDER_NOTIFY","data":"","appId":"62261998","sign":"","encryptKey":"","timestamp":"1749618909294","responseId":"JZY1113184231938"}';
        // $agentNo = '11111111';
        // $data = [
        //     'agentNo' => $agentNo,
        //     'customerName' => '测试商户',
        ...
        self::assertEquals('334779701719715840', $callbackRequest->getTransNo());
